...
// The original ParkIQ simulation dashboard, unchanged except that the shared header, Toast, and
// NewReportAlert now live in the Dashboard wrapper. Mounts only when mode === "sim".
export default function SimDashboard({ aiOpen, onAiClose }: Props) {
