  ...
  return (
    <section className="panel flex flex-col rounded-2xl p-4">
      <div className="flex items-center justify-between">
        <div className="eyebrow !text-accent">Forecast · next 45 min</div>
      ...
      {top.length === 0 ? (
        <div className="flex flex-1 flex-col justify-center py-3">
          <p className="font-display text-[14px] font-semibold text-ink-soft">You&apos;re ahead of it.</p>
          <p className="text-[12px] leading-relaxed text-muted">No new hotspots are forming in the next 45 minutes.</p>
        </div>
      ) : (
            ...
            <li key={p.roadId}>
              ...
              >
                ...
                <span className="shrink-0 text-right">
                  ...
                  <span className="tnum mt-0.5 block text-[9.5px] text-faint">in {Math.max(1, Math.round(p.etaMin - simMin))}m</span>
                </span>
              </button>
            </li>
          ))}
